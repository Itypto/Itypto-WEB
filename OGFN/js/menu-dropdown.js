(function () {
  ...
  const isChapterPage = currentPath.includes("/Html/ch") || currentPath.includes("\\Html\\ch");
  const assetBaseHref = isChapterPage ? "../../assets" : "../assets";
  const htmlBaseHref = isChapterPage ? ".." : ".";
  const homeHref = isChapterPage ? "../../../main/html/home.html" : "../../main/html/home.html";
  const buildsHref = `${htmlBaseHref}/Builds.html`;
  const tutorialsHref = `${htmlBaseHref}/Tutorials.html`;
  const aboutHref = `${htmlBaseHref}/AbtMe.html`;
  const projectHref = `${htmlBaseHref}/Project.html`;
  const assetsHref = `${htmlBaseHref}/Assets.html`;
  ...
  menu.innerHTML = `
    <a class="site-menu-link site-menu-link-home" href="${homeHref}">
    ...
    <a class="site-menu-link" href="${projectHref}">
      <span class="site-menu-icon" aria-hidden="true">
